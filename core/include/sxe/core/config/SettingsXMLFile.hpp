#ifndef SXE_CORE_CONFIG_SETTINGSXMLFILE__HPP
#define SXE_CORE_CONFIG_SETTINGSXMLFILE__HPP
/*-
...
namespace sxe { namespace core { namespace config {
    ...
    {
      public:
        using path_type = sxe::core::sys::FileSystem::path;
...
#endif // SXE_CORE_CONFIG_SETTINGSXMLFILE__HPP
