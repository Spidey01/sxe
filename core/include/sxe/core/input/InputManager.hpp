#ifndef SXE_CORE_INPUT_INPUTMANAGER__HPP
#define SXE_CORE_INPUT_INPUTMANAGER__HPP
/*-
...
#include <sxe/core/input/KeyEventManager.hpp>
...
namespace sxe { namespace core { namespace input {
     ...
     *
     * @see sxe::core::testing::NullInputManager.
     */
...
#endif // SXE_CORE_INPUT_INPUTMANAGER__HPP
