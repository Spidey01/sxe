...
public class HelloJRuby {
    private static final String TAG = "HelloJRuby";
    ...
    @Test
    public void hello() {
        // TODO: Rename HelloJavaScript to HelloWorld or something.
        //       It's that generic a simple test....lol.
        HelloJavaScript.hello(new JRubyScriptManager());
    }
