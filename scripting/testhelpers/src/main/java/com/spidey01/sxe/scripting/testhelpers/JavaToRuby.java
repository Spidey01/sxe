...
public class JavaToRuby {
    private static final String TAG = "JavaToRuby";
    ...
    public static void simple(ScriptManager manager) throws IOException, FileNotFoundException {
        ...
        File source = new File(resourcesDir, "JavaWrapper.rb");
    ...
    public static void get(ScriptManager manager) {
        ...
        /*
         * JRuby gives a Long and Double for simple whole and real numbers.
         */
        long x = (Long)manager.eval(script, "x = 7");
    ...
    public static void put(ScriptManager manager) {
        ...
        // since javaClass is a Java method, it should be returned as a Long.
        long sum = (Long)manager.eval(script, "javaClass.returnsSum(2, 2)");
