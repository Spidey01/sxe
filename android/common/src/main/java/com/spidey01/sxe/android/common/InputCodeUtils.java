...
public class InputCodeUtils {
    ...
    public static InputCode toSxE(int androidKeyCode) {
        switch (androidKeyCode) {
            ...
            case KeyEvent.KEYCODE_STAR: return InputCode.IC_ASTERISK;
            case KeyEvent.KEYCODE_POUND: return InputCode.IC_NUMBER_SIGN;
            ...
            case KeyEvent.KEYCODE_DEL: return InputCode.IC_BACKSPACE;
            case KeyEvent.KEYCODE_GRAVE: return InputCode.IC_GRAVE;
            case KeyEvent.KEYCODE_MINUS: return InputCode.IC_HYPHEN_MINUS;
            case KeyEvent.KEYCODE_EQUALS: return InputCode.IC_EQUAL_SIGN;
            case KeyEvent.KEYCODE_PLUS: return InputCode.IC_PLUS_SIGN;
            case KeyEvent.KEYCODE_LEFT_BRACKET: return InputCode.IC_LEFT_SQUARE_BRACKET;
            case KeyEvent.KEYCODE_RIGHT_BRACKET: return InputCode.IC_RIGHT_SQUARE_BRACKET;
            ...
            case KeyEvent.KEYCODE_AT: return InputCode.IC_AT_SIGN;
