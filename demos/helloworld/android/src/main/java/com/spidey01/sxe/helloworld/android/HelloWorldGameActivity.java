...
package com.spidey01.sxe.helloworld.android;
...
public class HelloWorldGameActivity extends GameActivity {

    protected GameEngine mEngine;
    private static final String TAG = "HelloWorldGameActivity";
